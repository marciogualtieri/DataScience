...
As expected, the list of feature names contains `r ncol(features)` entries, which matches with the number of columns in the feature data.
...
|-----------------|-------------------------------------------------------------------------------------------------------------|
|ActivityLabel    |A descriptive label for the activity, i.e.: LAYING, SITTING, WALKING, WALKING_UPSTAIRS or WALKING_DOWNSTAIRS.|
